...
%>
<head>
	<title>GH Request Approval</title>
...
<%  try{%> <div class="header">Letter Requests Approval</div><br><br>
			...
			<form action="gh-app-letter-action.jsp" method="post">
			...
			con = DriverManager.getConnection("jdbc:ucanaccess://G:\\Ecilipse\\DAK Management\\WebContent\\database.accdb");
			st = con.createStatement();
			rs = st.executeQuery("select sno,lno,sub,date1,sto,msg,file from smain where gto='"+name+"'");
