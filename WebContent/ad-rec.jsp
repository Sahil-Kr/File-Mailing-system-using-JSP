...
%>
<head>
	<title>AD Received Letter</title>
...
<%  try{%> <div class="header">Received Letter Approval</div><br><br>
			...
			<form action="ad-rec-action.jsp" method="post">
			...
			while(rs.next()){%>
					...
					<td>NA</td>
					<td>Received</td>
					<td><input type="radio" value="approve" name="sub-type">Approve<br><input type="radio" value="rej" name="sub-type"><br>Reject<br>
