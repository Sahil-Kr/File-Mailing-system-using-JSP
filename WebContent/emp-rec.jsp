...
<%  try{%> <div class="header">Received Letter</div><br><br>
			...
			<form action="emp-rec-action.jsp" method="post">
			...
			while(rs.next()){%>
					...
					<td>NA</td>
					<td>Received</td>
					<td><input type="radio" value="rep" name="sub-type"><br>Reply<br><input type="radio" value="ack" name="sub-type">Acknowledge<br>
			...
			if(sr.equals("1")){
				try{
					...
					while(rs.next()){%>
							...
							<td>Response</td>
							<td><input type="radio" value="ack" name="sub-type">Acknowledge<br>
							<input type="submit" value="Confirm"></td>
							</tr>
